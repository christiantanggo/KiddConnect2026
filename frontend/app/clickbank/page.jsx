...
export default function ClickBankAffiliatePage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-green-50 rounded-lg p-6 text-center">
              ...
              <div className="text-sm text-gray-600 mt-2">Per subscription</div>
            </div>
            <div className="bg-purple-50 rounded-lg p-6 text-center">
              <div className="text-4xl font-bold text-purple-600 mb-2">$89.25</div>
              <div className="text-gray-700 font-medium">You Earn</div>
              <div className="text-sm text-gray-600 mt-2">Per sale (75% of $119)</div>
            </div>
          </div>
        </div>
        ...
        {/* Product Overview */}
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">What is Tavari AI?</h2>
