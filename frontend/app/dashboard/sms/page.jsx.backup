...
import { AlertTriangle, ArrowRight, ArrowLeft, Phone, Check } from 'lucide-react';
            ...
            <div className="bg-white rounded-lg shadow p-6 space-y-6">
              ...
              <div className="border-t pt-4 mt-4">
                ...
                {selectedNumbers.length === 0 && availableNumbers.length > 0 && (
                  <p className="text-xs text-yellow-600 mt-2 flex items-center gap-1">
                    <AlertTriangle className="w-3 h-3" /> Please select at least one phone number to send from
                  </p>
                )}
              </div>
              ...
              {selectedNumbers.length === 0 && availableNumbers.length === 0 && (
                <p className="text-sm text-yellow-600 mt-2 flex items-center gap-1">
                  <AlertTriangle className="w-4 h-4" /> No SMS numbers available. The campaign will be created but cannot send until a phone number is configured.
                </p>
              )}
            </div>
          )}
