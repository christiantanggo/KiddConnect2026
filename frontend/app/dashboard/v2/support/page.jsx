...
function SupportPage() {
  ...
  const loadModules = async () => {
    try {
      ...
      try {
        ...
        // Keep modules as empty array - dropdown will just show "General / All Modules"
      }
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ issue_type: 'technical', description: '', urgency: 'normal', module_key: '' });
      setShowForm(false);
      await loadTickets();
    } catch (error) {
            ...
            <div className="bg-white rounded-lg shadow p-6 mb-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">Select the module this ticket relates to, if applicable</p>
                </div>
                <div>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {tickets.map((ticket) => (
                      <tr 
                        ...
                        onClick={() => router.push(`/dashboard/v2/support/${ticket.id}`)}
                      >
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                          <Link 
                            href={`/dashboard/v2/support/${ticket.id}`}
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                          {getModuleName(ticket.module_key)}
                        </td>
