              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-slate-200">
                  ...
                  <div className="mb-3">
                    ...
                    <input type="url" className="w-full max-w-2xl rounded border border-slate-300 px-3 py-2 text-sm" placeholder="https://www.kiddconnect.ca/termsofservice" value={config.terms_of_service_url || ''} onChange={(e) => { setConfig((c) => ({ ...c, terms_of_service_url: e.target.value })); setConfigDirty(true); }} />
                  </div>
                  <div className="mb-3">
