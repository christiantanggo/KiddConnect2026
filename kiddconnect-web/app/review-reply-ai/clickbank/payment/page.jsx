...
export default function ReviewReplyAIClickBankPaymentPage() {
  ...
  useEffect(() => {
    ...
    const id = params.get('clickbank_id') || localStorage.getItem('clickbank_id_reviews') || '';
    setClickbankId(id);
  ...
  const generatePaymentLink = (id) => {
    ...
    // Format: https://www.kiddconnect.ca/review-reply-ai/landing?clickbank_id=YOUR_ID
    const baseUrl = window.location.origin;
    const link = `${baseUrl}/review-reply-ai/landing?clickbank_id=${id}`;
    setPaymentLink(link);
    localStorage.setItem('clickbank_id_reviews', id);
  };
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              <Link href="/review-reply-ai/clickbank" className="text-gray-700 hover:text-blue-600 font-medium transition-colors">
